  ...
  const skills = [
    ...
    { 
      ...
      learningResources: [
        ...
        { name: "Building REST APIs with Express", url: "https://www.robinwieruch.de/node-express-server-rest-api/" }
      ]
    },
    { 
      name: "Next Js", 
      ...
      learningResources: [
        ...
        { name: "Next.js Tutorial", url: "https://www.youtube.com/watch?v=MFuwkrseXVE" },
    ...
    { 
      ...
      learningResources: [
        ...
        { name: "NestJS Tutorial", url: "https://www.youtube.com/watch?v=DLX62G4lc44" },
        { name: "NestJS Course", url: "https://www.udemy.com/course/nestjs-zero-to-hero/" }
      ]
    },
    { 
      name: "Javascript", 
      ...
      learningResources: [
        ...
        { name: "JavaScript Tutorial", url: "https://www.youtube.com/watch?v=PkZNo7MFNFg" },
    ...
    { 
      ...
      learningResources: [
        ...
        { name: "Redux Fundamentals", url: "https://redux.js.org/tutorials/fundamentals/part-1-overview" }
      ]
    },
    { 
      name: "Tailwind", 
    ...
    { 
      ...
      learningResources: [
        ...
        { name: "Redis Tutorial", url: "https://www.youtube.com/watch?v=DL19N1ku3PE" },
    ...
    { 
      ...
      learningResources: [
        ...
        { name: "Bun Tutorial", url: "https://www.youtube.com/watch?v=74k8yxMlIT8" },
    ...
    { 
      ...
      learningResources: [
        ...
        { name: "Hono Tutorial", url: "https://www.youtube.com/watch?v=9XWgmANi5-Q" },
    ...
    { 
      ...
      learningResources: [
        ...
        { name: "SQL Tutorial for Beginners", url: "https://www.youtube.com/watch?v=HXV3zeQKqGY" },
    ...
    { 
      ...
      learningResources: [
        ...
        { name: "CI/CD Best Practices", url: "https://www.cloudbees.com/blog/cicd-best-practices" }
      ]
    },
    { 
      name: "Prometheus", 
      ...
      learningResources: [
        ...
        { name: "Prometheus Tutorial", url: "https://www.youtube.com/watch?v=h4Sl21AKiFY" },
    ...
    { 
      ...
      learningResources: [
        ...
        { name: "Grafana Tutorial", url: "https://www.youtube.com/watch?v=2GMK9OY53AM" },
    ...
    { 
      ...
      learningResources: [
        ...
        { name: "Zod Tutorial", url: "https://www.youtube.com/watch?v=P6IUhCxvy5E" },
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="grid grid-cols-8 gap-6">
          {skills.map((skill, index) => (
            ...
            >
              {/* ICON WITHOUT INNER BORDER */}
              <div className="p-3 bg-[#E8FFEA]">
                {skill.icon}
              </div>
